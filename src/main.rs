...
impl App {
    fn new(event_loop: &EventLoop<()>) -> Self {
        ...
        let required_extensions = Surface::required_extensions(event_loop).unwrap(); //  If this crashes it's the raw handles versions mismatch
...
impl ApplicationHandler for App {
    ...
    // Method called on initialization and returns from suspended state
    // Here we use it to initialize Vulkano
