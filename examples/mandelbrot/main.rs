...
pub fn main() {
    ...
    let shader = cs::load(device.clone()).expect("failed to craete shader module");
    ...
    builder
        ...
        // In this vulkano we need to put this unsafe block. It means WE need to make sure the shader
        // is safe, as rustc can't.
        unsafe {
            builder.dispatch([1024 / 8, 1024 / 8, 1])
                    .unwrap();
        }
